...
<div class="task-container" class:new={isNew} in:fly|global={{ x: -150 }}>
	<p class="task-title">{name}</p>
	<div class="task-actions">
		<button class="remove-task-button" on:click={handleRemove}
...
<style lang="postcss">
	.task-container {
		@apply flex w-full h-8 bg-neutral-400/30 mb-1 transition-colors rounded-md px-2 shadow-md items-center;
	}
